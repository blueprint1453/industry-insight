...
NAND Flash市场是全球存储芯片市场的重要组成部分，2024年全球NAND Flash市场规模约650亿美元，其中企业级SSD约150亿美元。AI服务器需求推动企业级SSD成为增长最快的细分市场，预计2025年AI相关SSD需求将推动NAND市场增长20%以上。三星、SK海力士（含Solidigm）、铠侠、美光、西部数据五家厂商主导全球NAND Flash供应。国内长江存储（YMTC）凭借Xtacking架构在3D NAND领域实现突破，已量产232层产品，跻身全球第一梯队。
...
全球NAND Flash市场高度集中，前五大厂商占据超过95%市场份额。三星电子以约33%的份额位居第一，在消费级和企业级SSD市场均占据主导。SK海力士（含Solidigm）约20%份额排名第二，其Solidigm部门原为Intel NAND业务，在企业级SSD领域实力雄厚。铠侠约19%份额排名第三，与西部数据联合运营四日市工厂。美光约13%份额，西部数据约12%份额。

```mermaid
pie title 2024年全球NAND Flash市场份额（约）
    "三星电子" : 33
    "SK海力士/Solidigm" : 20
    "铠侠 Kioxia" : 19
    "美光科技" : 13
...
2024年全球NAND Flash市场规模约650亿美元，其中企业级SSD约150亿美元，消费级SSD约200亿美元，嵌入式存储约180亿美元。AI大模型训练推动企业级SSD需求爆发式增长，高容量PCIe 5.0 NVMe SSD供不应求。国内方面，长江存储已实现232层3D NAND量产，产能达10万片/月以上，产品覆盖消费级和企业级SSD。长江存储的Xtacking架构在堆叠效率和性能上达到国际先进水平，是国内存储产业链的关键突破。
...
NAND Flash闪存是AI数据基础设施的基石。大模型训练需要从SSD加载海量训练数据（文本语料、图像、视频），SSD的读取带宽直接影响数据供给效率。训练过程中的检查点定期保存需要在不影响训练的前提下快速写入数百GB模型状态，要求SSD具备高顺序写入带宽和低延迟。AI推理服务器的高并发模型加载同样依赖高IOPS SSD。
