...
全球存储安全市场规模约30-40亿美元，包括硬件加密芯片、SED SSD、TPM芯片、KMS/HSM密钥管理、数据销毁服务等。AI数据安全需求推动市场年增速15-20%。
...
**TCG Opal SSD**：主流企业级SSD均支持TCG Opal，包括Samsung、Micron、Kioxia、Western Digital、Solidigm。SED管理软件由Micro Focus（原Attachmate）、Wave Systems、CipherCloud等提供。中国自主可控存储安全方案由华为、浪潮、紫光等推进。
...
```mermaid
pie title 2024年企业级SED SSD加密市场份额（约）
    "Samsung 三星" : 30
    "Micron 美光" : 20
    "Kioxia 铠侠" : 15
    "Solidigm" : 12
...
**需求拉动**：企业级SSD硬件加密和TCG Opal支持已成为AI存储的标配要求。全球企业级SSD出货量随AI算力建设增长，其中支持硬件加密的SED SSD渗透率达70%+。TPM 2.0芯片在AI服务器中100%标配。数据销毁服务需求随AI数据中心退役周期到来而增长。
