...
3D NAND是SSD固态硬盘、手机存储和嵌入式存储的核心基础。随着AI训练数据集快速增长和企业级SSD需求爆发，3D NAND的市场需求持续旺盛。2024年3D NAND市场规模约500-600亿美元，是存储行业最大的单一产品类别。三星、铠侠、SK海力士、美光和长江存储是全球五大3D NAND厂商，技术竞争激烈。
...
**三星V-NAND路线**：三星是3D NAND的开创者和领导者。从V6（128层）、V7（176层）到V8（236层）和V9（280+层），三星采用CTF技术，CMOS Under Array布局。三星V-NAND在产能和技术成熟度上领先。

**铠侠/西部数据BiCS路线**：BiCS（Bit Cost Scalable）是铠侠的3D NAND技术。BiCS5为112层，BiCS6为162层，BiCS7为200+层。采用CMOS Around Array布局，与三星路线不同。铠侠与西部数据合资运营日本三重/四日市工厂，是全球第二大3D NAND产能。

**SK海力士4D NAND路线**：SK海力士将CTF与COP（CMOS Under Array）结合称为"4D NAND"。从128层到176层到238层，SK海力士正推进321层产品。

**美光路线**：美光从128层到176层到232层，采用CMOS Under Array方案。美光在232层3D NAND上率先量产，并向更高层数推进。

**长江存储Xtacking路线**：长江存储是中国唯一的3D NAND厂商。Xtacking架构将外围电路和存储阵列分别在两片晶圆上制造，通过晶圆键合集成。从Xtacking 2.0（128层）到Xtacking 3.0（232层），长江存储已实现232层量产，正在研发300+层产品。
...
全球3D NAND市场由五大厂商主导。按产能计算，三星约33%居首，铠侠/西部数据约19%，SK海力士约18%，美光约13%，长江存储约5-7%，其他约10%。2024年全球3D NAND产能折合约每月120-130万片晶圆（折合128层）。

3D NAND市场规模2024年约550亿美元，预计2025年随AI服务器和企业级SSD需求增长突破650亿美元。AI训练数据集的高速增长、SSD在数据中心渗透率提升以及手机存储容量升级共同推动3D NAND需求。

长江存储是中国3D NAND自主化的唯一力量，232层Xtacking 3.0产品在技术和性能上已接近国际主流水平，产能持续扩张，预计2025年产能将达月10万片以上。

```mermaid
pie title 全球3D NAND产能份额（约2024）
    "三星" : 33
    "铠侠/WD" : 19
    "SK海力士" : 18
    "美光" : 13
...
|------|----------|-------------|---------|
| 三星 | 韩国 | V-NAND V8 236层/V9 280+层 | 全球3D NAND龙头，份额33% |
| 铠侠(Kioxia) | 日本 | BiCS6 162层/BiCS7 200+层 | 全球第二大，与WD合资 |
| 西部数据(WD) | 美国 | 与铠侠合资运营 | BiCS合作伙伴 |
| SK海力士 | 韩国 | 4D NAND 238层/321层研发 | 全球第三大3D NAND厂商 |
| 美光 | 美国 | 232层量产/300+层研发 | 232层率先量产 |
| 长江存储(YMTC) | 中国 | Xtacking 3.0 232层 | 中国唯一3D NAND厂商，自主技术 |
| Solidigm | 美国 | 144层/192层 | Intel NAND业务剥离给SK |
| PHISON(群联) | 中国台湾 | 3D NAND控制器/模组 | 主控芯片和SSD方案商 |

## 发展趋势

**堆叠层数持续突破**：3D NAND堆叠层数从当前232-300层向400+层演进。三星V9（280+层）、SK海力士321层、长江存储300+层均在研发中。堆叠层数增长是3D NAND密度提升的核心路径。
...
**国产替代深化**：长江存储232层Xtacking 3.0已具备国际竞争力，未来300+层产品将进一步缩小与三星差距。国内供应链自主化持续深化。

## AI基建拉动分析

AI基建浪潮对3D NAND形成强烈拉动。AI训练数据集规模从TB级向PB级甚至EB级增长，需要大量高速SSD存储训练数据和模型检查点（checkpoint）。企业级NVMe SSD是3D NAND在AI服务器中的核心应用，单台AI服务器SSD配置可达数十TB。
